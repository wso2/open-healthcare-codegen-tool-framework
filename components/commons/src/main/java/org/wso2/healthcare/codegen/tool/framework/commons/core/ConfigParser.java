...
/**
 * Interface that needs to be implemented to parse the protocol specifications tool configurations.
 */
public interface ConfigParser {
     ...
     *
     * @return {@link ToolConfig} protocol level tool configuration.
     */
    ToolConfig parse();
}
